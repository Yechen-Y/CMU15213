...
0000000000400fce <func4>: //edx = e  esi = 0
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax // r = z
  400fd4:	29 f0                	sub    %esi,%eax // r = z - y
  400fd6:	89 c1                	mov    %eax,%ecx // j = r =z - y
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx //j = j >> 31 = (z-y) >> 31
  400fdb:	01 c8                	add    %ecx,%eax // r = r + j = z - y+ (z-y)>>31
  400fdd:	d1 f8                	sar    %eax //r = z - y+ (z-y)>>31 / 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx //j = r + y = z + y+ (z-y)>>31 / 2
  400fe2:	39 f9                	cmp    %edi,%ecx // j - x ---> z和y中中位数与 x的关系
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> // 若x 小于或等于中位数
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx // 若大于 则 z = r - 1  中位数-1
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax
  400ff7:	39 f9                	cmp    %edi,%ecx // j - x 中位数和 x的关系
  400ff9:	7d 0c                	jge    401007 <func4+0x39>
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi //若中位数小于x y= z + 1 
...
000000000040100c <phase_4>:
  ...
  40102c:	75 07                	jne    401035 <phase_4+0x29> //若输入数 数量不等于二 则引爆
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) 
  401033:	76 05                	jbe    40103a <phase_4+0x2e> //若输入的第一个数大于0xe 则引爆
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi //第一个输入的数设置为传入func4的第一个参数
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax // eax = 0 即rax = 0
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) //输入的第二个数为0
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx //rbx 存储已读数据的地址
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp) //canary on stack 24bytes
  401078:	31 c0                	xor    %eax,%eax // 清零rax
  40107a:	e8 9c 02 00 00       	call   40131b <string_length> //获取已读数据的长度
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70> //若已读数据的长度等于6则跳转到 [1]
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb> // 不等于6则引爆
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx       // [2] ecx = x[i] ，其中 i = 0 
  40108f:	88 0c 24             	mov    %cl,(%rsp) // 将字符复制到rsp所指的地方
  401092:	48 8b 14 24          	mov    (%rsp),%rdx // 并赋给rdx
  401096:	83 e2 0f             	and    $0xf,%edx  // 保留edx的低四位其余清零
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx //用x[i]字符的低四位加上offset寻址，取1Byte给edx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) // 将改 1Byte存到 （rsp+10+i)
  4010a4:	48 83 c0 01          	add    $0x1,%rax  // i++
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax   
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>  // 若 i < 6 则跳转到 [2]
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp) //相当于加上终止符号\0
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax    // 若两个字符串相等则退出
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> //跳转到 [3] 
  4010c6:	e8 6f 03 00 00       	call   40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax              //  [1] 清零eax
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>  // 跳转到 [2]
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax      // [3] 检查是否有缓存区泄露  
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax //检查canary是否改变
  4010e5:	00 00 
...
00000000004010f4 <phase_6>:  // x - 1 <=5  --> 1 <= x <= 6   6 >= 7 - x >= 1
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers> //将read_line获得的数字放到栈上
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d  //设置一个count 计数器
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax  // eax = x[0]
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> // x[0] - 1 > 5 则引爆 否则跳转到 [1]
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d   // [1]
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f> //若遍历完6个数字 则跳转到 [2]
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax //第一次是比较x[1] 和 x[0]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) //比较 x[i] 和 x[i + 1] 
  ...
  401151:	eb c1                	jmp    401114 <phase_6+0x20> //这一大段保证了6个数字都不相同
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi        //  [2]
  401158:	4c 89 f0             	mov    %r14,%rax   // rax 栈顶 rsi = rsp + 24 中间刚好6int 
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx
  401164:	89 10                	mov    %edx,(%rax)  // x[0] = 7 - x[0]
  401166:	48 83 c0 04          	add    $0x4,%rax  // rax指向下一个int
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>// 对六个数字都执行该操作  x[i] = 7 - x[i]
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> //跳转到 [3]
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx   // [6]  rdx =0x6032d0  
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax   // x[i]与 2 、3、4 比较
  40117f:	75 f5                	jne    401176 <phase_6+0x82> //x[i] != 2、3、4 则跳转到 [6]   这里其实是用eax记录x[i]的值
  401181:	eb 05                	jmp    401188 <phase_6+0x94> //跳转到[7]
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx  // [4] 
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) //间隔为 8 bytes  输入0x6032d0或者x[i]！=1时的值  //[7]
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7> // 循环6次后 跳转到 [5]
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx       //  [3]
  40119a:	83 f9 01             	cmp    $0x1,%ecx  // ecx = x[i] 每跳转到一次都转换到一下个int 
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>  // 若int 小于等于1 则跳转到 [4]   
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>  // 跳转到 [6]
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx      //  [5]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx // rcx = (rsp + 32) node 6
  4011bd:	48 8b 10             	mov    (%rax),%rdx // rdx = (rsp + 40) node 5
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) // ((rsp + 32) + 8) = (rsp + 40)
  4011c4:	48 83 c0 08          	add    $0x8,%rax // rax = rsp + 48
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx // (rsp + 32) = (rsp + 40)
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) // 尾结点指向0
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax //rax = ((rsp + 32) +8)
  4011e3:	8b 00                	mov    (%rax),%eax // eax指向下一个结点
  4011e5:	39 03                	cmp    %eax,(%rbx) //rbx 指向当前结点
...
000000000040131b <string_length>:
  ...
  40131e:	74 12                	je     401332 <string_length+0x17> // 若x的低8位为0则跳转到 [1]
  ...
  401332:	b8 00 00 00 00       	mov    $0x0,%eax // [1]
  401337:	c3                   	ret    

0000000000401338 <strings_not_equal>: //equal 返回0 
